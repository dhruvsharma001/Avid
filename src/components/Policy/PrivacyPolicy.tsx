export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cinemachines Private Limited, D 39 chomu
            house CScheme Jaipur 302001.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to cniemachines, accessible from{" "}
            <a
              href="cniemachines.com"
      ...
      <ul>
        <li>By email: support@cinemachines.com</li>
      </ul>
    </div>
  );
}
